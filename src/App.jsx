    ...
    <div className="min-h-screen bg-slate-950 flex">
      ...
      <aside className="hidden md:flex flex-col w-56 bg-slate-900 border-r border-slate-800 fixed h-full z-20">
        ...
        <div className="p-4 border-t border-slate-800">
          <p className="text-xs text-slate-600 font-mono">v1.2.0 · Local-First</p>
        </div>
      </aside>
      ...
      <div className="fixed bottom-16 right-3 md:bottom-3 z-40 pointer-events-none">
        <span className="text-xs font-mono text-slate-700 bg-slate-900/80 px-2 py-0.5 rounded-full border border-slate-800">
          v1.2.0
        </span>
      </div>
    </div>
